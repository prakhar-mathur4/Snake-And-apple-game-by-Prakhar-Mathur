...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Snake And Apple Game By Prakhar Mathur")
    ...
    def show_game_over(self):
        ...
        font = pygame.font.SysFont('poppins', 30)
        line1 = font.render(f"Oppss!!..Game is over! Your score is {self.snake.length}", True, (255, 255, 255))
